...
[![Generic badge](https://img.shields.io/badge/License-Apache-blue.svg?style=for-the-badge)](LICENSE)
[![GitHub Issues](https://img.shields.io/github/issues/your-org/your-repo.svg?style=for-the-badge)](../../issues)
...
>
> To use Unstructured.io based solution, refer the earlier release tag.
...
Screenshots and live demos are not included in this repository.
...
Contributions are welcome! Please open an issue for feature requests and improvements. 
...
## Citing
If you use this project in academic work, please cite the upstream open-source papers listed in [`agents/README.md`](agents/README.md) and the LangGraph / LangChain / Qdrant / Docling papers referenced in their documentation.

---

## Contact

For questions or collaboration inquiries, please open a GitHub issue on this repository.
